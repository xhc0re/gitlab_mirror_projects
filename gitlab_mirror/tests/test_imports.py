...
def test_core_imports():
    ...
    from gitlab_mirror.core import config, exceptions
    from gitlab_mirror.core.config import GitLabConfig, MirrorConfig, get_env_variable
    from gitlab_mirror.core.exceptions import ApiError, ConfigError, MirrorError
...
def test_utils_imports():
    ...
    from gitlab_mirror.utils import trigger, update, verify
