...
class MirrorVerifier:
            ...
            for mirror in mirrors:
                ...
                if expected_mirror_path in mirror_url:
                    ...
                    if not mirror.enabled or hasattr(mirror, 'last_error') and mirror.last_error:
                        return True, mirror.last_error if hasattr(mirror, 'last_error') else "Mirror is disabled"
                    return True, ""
    ...
    def print_report(self):
        ...
        total_processed = self.success_count + len(self.missing_in_target) + len(self.missing_mirrors) + len(self.failed_mirrors)
    ...
    def export_reports(self):
        ...
        if unique_fix_projects:
            ...
            logger.info(f"Exported {len(unique_fix_projects)} projects to 00-fix.csv in projects.csv format")