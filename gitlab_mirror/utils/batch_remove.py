...
def remove_mirrors_from_csv(
    ...
    try:
        with open(csv_file, 'r', encoding='utf-8') as f:
            ...
            if first_line and not first_line[0].startswith('#') and 'source_path' not in str(first_line[0]).lower():
            ...
            for mirror in mirrors:
                if dry_run:
                    ...
                    try:
                        ...
                        logger.error("Failed to remove mirror %s from %s: %s", mirror.id, project_path, e)
